...
object Untyped extends StandardTokenParsers {
  ...
  def reduceNormalOrder(t: Term): Term = t match{
    ...
    case App(Abs(str, t), t1) => subst(t, str, t1)
    case App(t1,t2) => t1 match{
      case Abs(str, t) => App(reduceNormalOrder(t1),t2)
      case App(t3, t4) => App(reduceNormalOrder(t1),t2)
      case Var(str) => App(t1, reduceNormalOrder(t2))
    }
